...
from skills_ml.job_postings.raw.seek_aus import SeekAusTransformer
...
class JobPostingCollectionSampleFile(object):
    ...
    def __init__(self, num_records:int=50):
        ...
        #f = gzip.GzipFile(filename=full_filename)
        full_filename = '/Users/abhinavsingh/Documents/skillsml/seek_au-jobs_listing__20190901_20191231_sample.ldjson'
        print(full_filename)
